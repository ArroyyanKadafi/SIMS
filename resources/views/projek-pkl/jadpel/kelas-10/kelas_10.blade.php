              ...
              <div class="card">
                <div class="row">
                  <div class="col-md-6"> -->
                    ...
                    <table class="table table-bordered border-secondary text-center mt-3 mb-1">
                      <tr class="text-center border-secondary">
                        ...
                        <th class="table-primary border-secondary" scope="col" colspan="12">Class</th>   
                        <th class="table-info border-secondary" scope="col" rowspan="3">Action</th>                                                
                      </tr>
                        ...
                        <tr>
                          <th scope="col" class="table-primary border-secondary" >10-A</th>
                          <th scope="col" class="table-primary border-secondary" >10-B</th>
                          <th scope="col" class="table-primary border-secondary" >10-C</th>   
                          <!--  -->
                          <th scope="col" class="table-primary border-secondary" >10-A</th>
                          <th scope="col" class="table-primary border-secondary" >10-B</th>
                          <th scope="col" class="table-primary border-secondary" >10-C</th>
                      ...
                      <tbody class="border-secondary">
                        ...
                        <tr>
                          ...
                          <td class="table-secondary border-secondary">{{ $dataJadpel->mapel }}</td>
                          <td class="table-secondary border-secondary">{{ $dataJadpel->mapel }}</td>
                          <td class="table-secondary border-secondary">
                            <a href="{{ url('/kelas_10/edit/'.$dataJadpel->id) }}" class="btn btn-success ti-pencil-alt mr-2"> Edit</a> 
                            <form action="{{ url('/kelas_10/delete/'.$dataJadpel->id) }}" method="POST" class="d-inline">
                              @method('delete')
                              @csrf
                    ...
                    <a href="{{ url('/kelas_10/create') }}" class="btn btn-info mt-2 ti-plus mr-2 mb-5"> Add Lesson Schedule</a> 
