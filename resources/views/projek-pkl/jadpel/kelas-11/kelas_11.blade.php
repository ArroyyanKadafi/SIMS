                  ...
                  <div class="col-md-6"> -->
                    ...
                    <table class="table table-bordered border-secondary text-center mt-3">
                      <tr class="text-center border-secondary">
                        ...
                        <tr>
                          <th scope="col" class="table-primary border-secondary" >11-A</th>
                          <th scope="col" class="table-primary border-secondary" >11-B</th>
                          <th scope="col" class="table-primary border-secondary" >11-C</th>   
                          <!--  -->
                          <th scope="col" class="table-primary border-secondary" >11-A</th>
                          <th scope="col" class="table-primary border-secondary" >11-B</th>
                          <th scope="col" class="table-primary border-secondary" >11-C</th>
