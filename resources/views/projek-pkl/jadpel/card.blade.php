                ...
                <div class="container">
                  <div class="row">                 
                    <div class="col-md-12 col-sm-6 col-lg-3">
                        <div class="card bg-primary text-white mb-5 stretch-card transparent">
                        <div class="card-body">
                            <div class="card-body-icon mt-3">
                                <i class="ti-agenda"></i>
                            </div>                        
                            <h4 class="card-title text-white">Lesson Schedule</h4>
                            <h4 class="card-text mt-4">Class 10</h4>
                            <a href="{{ url('/kelas_10') }}" class="btn btn-light mt-5">Detail <i class="ti-angle-double-right" style="font-size: 13px;"></i></a>
                        </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-6 col-lg-3">
                        <div class="card bg-danger text-white mb-5 stretch-card transparent">
                        <div class="card-body">
                            <div class="card-body-icon mt-3">
                                <i class="ti-agenda"></i>
                            </div>
                            <h4 class="card-title text-white">Lesson Schedule</h4>
                            <h4 class="card-text">Class 11</h4>
                            <a href="{{ url('/kelas_11') }}" class="btn btn-light mt-5">Detail  <i class="ti-angle-double-right" style="font-size: 13px;"></i></a>
                        </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-3">
                        <div class="card bg-warning text-white mb-5 stretch-card transparent">
                        <div class="card-body">
                            <div class="card-body-icon mt-3">
                                <i class="ti-agenda"></i>
                            </div>
                            <h4 class="card-title text-white">Lesson Schedule</h4>
                            <h4 class="card-text">Class 12</h4>
                            <a href="{{ url('/kelas_12') }}" class="btn btn-light mt-5">Detail  <i class="ti-angle-double-right" style="font-size: 13px;"></i></a>
                        </div>
                        </div>
                    </div>
                    </div>
