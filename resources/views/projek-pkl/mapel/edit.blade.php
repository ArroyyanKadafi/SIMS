              ...
              <div class="card">  
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    ...
                    <form action="{{ url('/mapel/update/'.$mapel->id) }}" method="POST" class="ml-3 mt-3">
                    @method('PUT')
                        @csrf                        
                        <div class="mb-3">
                            <label for="kode" class="form-label">Subject Code :</label>
                            <input type="text" name="kode_mapel" class="form-control" id="kode" style="width: 120vh;" value="{{ $mapel->kode_mapel }}">
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Subject :</label>
                            <input type="text" name="nama_mapel" class="form-control" id="nama" style="width: 120vh;" value="{{ $mapel->nama_mapel }}">
                        </div>
                        <div class="mb-3">
                            <label for="guru" class="form-label">Subject Teacher :</label>
                            <input type="text" name="guru" class="form-control" id="guru" style="width: 120vh;" value="{{ $mapel->guru }}">
                        </div>                       
