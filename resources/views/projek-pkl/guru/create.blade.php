          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">  
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    <h3 class="ti-user mr-3 mt-3 ml-3"> Form Add Teacher</h3><hr style="width: 150vh;">

                    <form action="{{ url('guru') }}" method="POST" class="ml-3 mt-3">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode_guru" class="form-control" id="kode_guru" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
