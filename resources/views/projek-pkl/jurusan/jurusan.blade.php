          ...
          <div class="row">
            <!-- <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="row">
                  <div class="col-md-6"> -->
                    <a href="/jurusan" class="text-dark" style="text-decoration: none;"><h3 class="ti-medall-alt mr-3 mt-3"> List of Department</h3></a>
                    ...
                    <table class="table table-hover table-light text-center mt-3">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{ url('/jurusan/edit/'.$dataJurusan->id) }}" class="btn btn-success ti-pencil-alt mr-2"> Edit</a> 

                            <form action="{{ url('/jurusan/delete/'.$dataJurusan->id) }}" method="POST" class="d-inline">
                              @method('delete')
                              @csrf
                              <!-- <input type="hidden" name="_method" value="DELETE"> -->
                              <button type="submit" class="btn btn-danger ti-trash mr-2 border-0 delete" data-id="{{  $dataJurusan->id }}" onclick="return confirm('Are you sure ?')"> Delete</button>
                            </form>     
                          </td>
                        </tr>                        
                        @endforeach
                    ...
                    <a href="{{ url('jurusan/create') }}" class="btn btn-info mt-2 ti-plus mr-2"> Add Department</a> 
