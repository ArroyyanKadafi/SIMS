              ...
              <div class="card">  
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    ...
                    <form action="{{ url('jurusan') }}" method="POST" class="ml-3 mt-3">
                        @csrf                        
                        <div class="mb-3">
                            <label for="kode" class="form-label">Department Code :</label>
                            <input type="text" name="kode_jurusan" class="form-control" id="kode" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Department :</label>
                            <input type="text" name="nama_jurusan" class="form-control" id="nama" style="width: 120vh;">
                        </div>                       
