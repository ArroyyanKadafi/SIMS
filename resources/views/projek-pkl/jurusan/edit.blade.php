          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">  
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    <h3 class="ti-medall-alt mr-3 mt-3 ml-3"> Form Add Department</h3><hr style="width: 150vh;">

                    <form action="{{ url('/jurusan/update/'.$jurusan->id) }}" method="POST" class="ml-3 mt-3">
                    @method('PUT')
                        @csrf                        
                        <div class="mb-3">
                            <label for="kode" class="form-label">Department Code :</label>
                            <input type="text" name="kode_jurusan" class="form-control" id="kode" style="width: 120vh;" value="{{ $jurusan->kode_jurusan }}">
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Department :</label>
                            <input type="text" name="nama_jurusan" class="form-control" id="nama" style="width: 120vh;" value="{{ $jurusan->nama_jurusan }}">
                        </div>                       
