              ...
              <div class="card">
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    ...
                    <h3 class="ti-money ml-3 mt-3 mr-2"> Payments</h3><hr style="width: 150vh;">                       
                    <form action="{{ url('/spp/update/' .$spp->id) }}" method="POST" class="ml-3 mt-3">
                    @method('PUT') 
                        @csrf
                    <div class="mb-3">
                            <label for="nis" class="form-label">SPN :</label>
                            <input type="text" name="nis" id="nis" class="form-control" style="width: 120vh;" value="{{ $spp->nis }}">
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Student Name :</label>
                            <input type="text" name="nama" id="nama" class="form-control" style="width: 120vh;" value="{{ $spp->nama }}">
                        </div>                        
                        <div class="mb-3">
                            <label for="tanggal" class="form-label">Payment Date :</label>
                            <input type="date" name="tanggal" id="tanggal" class="form-control" style="width: 120vh;" value="{{ $spp->tanggal }}">
                        </div>
                        <div class="mb-3">
                            <label for="bulan" class="form-label">Payment Month :</label>
                            <input type="month" name="bulan" id="bulan" class="form-control" style="width: 120vh;" value="{{ $spp->bulan }}">
                        </div>
                        <div class="mb-3">
                            <label for="kelas" class="form-label">Class :</label>
                            <input type="text" name="kelas" id="kelas" class="form-control" style="width: 120vh;" value="{{ $spp->kelas }}">
                        </div>
                        <div class="mb-3">                            
                                <label for="disabledSelect" class="form-label">Department :</label>
                                <select id="disabledSelect" name="jurusan" class="form-select" style="width: 120vh;" value="{{ $spp->jurusan }}">
                        ...
                        <div class="mb-3">
                            <label for="jumlah" class="form-label">Amount of Payment :</label>
                            <input type="text" name="jumlah" id="jumlah" class="form-control" style="width: 120vh;" value="{{ $spp->jumlah }}" placeholder="Rp. - - - - - - -">
                        </div>
                            <button type="submit" class="btn btn-primary mb-3 float-right">Submit</button>                           
                    <!-- <a href="#" class="btn btn-info mt-2 ti-plus mr-2"> Add Department</a> 
