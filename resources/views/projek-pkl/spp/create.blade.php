              ...
              <div class="card">
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    ...
                    <form action="{{ url('spp') }}" method="POST" class="ml-3 mt-3">
                        @csrf
                    <div class="mb-3">
                            <label for="nis" class="form-label">SPN :</label>
                            <input type="text" name="nis" id="nis" class="form-control" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Student Name :</label>
                            <input type="text" name="nama" id="nama" class="form-control" style="width: 120vh;">
                        </div>                        
                        <div class="mb-3">
                            <label for="tanggal" class="form-label">Payment Date :</label>
                            <input type="date" name="tanggal" id="tanggal" class="form-control" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="bulan" class="form-label">Payment Month :</label>
                            <input type="month" name="bulan" id="bulan" class="form-control" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="kelas" class="form-label">Class :</label>
                            <input type="text" name="kelas" id="kelas" class="form-control" style="width: 120vh;">
                        </div>
                        <div class="mb-3">                            
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jumlah" id="jumlah" class="form-control" style="width: 120vh;" placeholder="Rp. - - - - - - -">
                        </div>
