                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">               
                    <div class="card">
                        ...
                        <img src="/images/user.png" class="rounded mx-auto d-block">
                        <div class="card-body">                          
                            <div class="mb-3">
                                <label for="nip" class="form-label text-left">SPN :</label>
                                <input class="form-control" type="text" value="{{ $siswa->nis }}" aria-label="Disabled input example" disabled readonly>                               
                            </div>
                            <div class="mb-3">
                                <label for="nama_guru" class="form-label">Student Name :</label>
                                <input class="form-control" type="text" value="{{ $siswa->nama }}" aria-label="Disabled input example" disabled readonly>
                            </div>
                            <div class="mb-3">
                                <label for="tempat_lahir" class="form-label">Place of Birth :</label>
                                <input class="form-control" type="text" value="{{ $siswa->tempat_lahir }}" aria-label="Disabled input example" disabled readonly>
                            </div>                            
                            <div class="mb-3">
                                <label for="tanggal_lahir" class="form-label">Date of Birth :</label>
                                <input class="form-control" type="text" value="{{ $siswa->tanggal_lahir }}" aria-label="Disabled input example" disabled readonly>
                            </div>
                            <div class="mb-3">                            
                               <label for="disabledSelect" class="form-label">Gender :</label>
                               <input class="form-control" type="text" value="{{ $siswa->jk }}" aria-label="Disabled input example" disabled readonly>
                            </div>
                            <div class="mb-3">
                                <label for="kode_guru" class="form-label">Religion :</label>
                                <input class="form-control" type="text" value="{{ $siswa->agama }}" aria-label="Disabled input example" disabled readonly>
                            </div>
                            <div class="mb-3">
                                <label for="kode_guru" class="form-label">Blood Type :</label>
                                <input class="form-control" type="text" value="{{ $siswa->gol_dar }}" aria-label="Disabled input example" disabled readonly>
                            </div>
                            <div class="mb-3">
                                <label for="alamat" class="form-label">Address :</label>
                                <input class="form-control" type="text" value="{{ $siswa->kelas }}" aria-label="Disabled input example" disabled readonly>
                            </div>
                            <div class="mb-3">
                                <label for="alamat" class="form-label">Department :</label>
                                <input class="form-control" type="text" value="{{ $siswa->jurusan }}" aria-label="Disabled input example" disabled readonly>
                            </div>
                            <div class="mb-3">
                                <label for="honor_perjam" class="form-label">Phone Number :</label>
                                <input class="form-control" type="text" value="{{ $siswa->no_telp }}" aria-label="Disabled input example" disabled readonly>
                            </div>
                            <div class="mb-3">
                                <label for="alamat" class="form-label">Address :</label>
                                <input class="form-control" type="text" value="{{ $siswa->alamat }}" aria-label="Disabled input example" disabled readonly>
                            </div> 
                            <a href="{{ url('/siswa/print2/'.$siswa->id) }}" target="_blank" class="btn btn-warning mt-2 ti-printer mr-2 float-right"> Print</a>                                 
                </div>                        
              </div>
            </div>                  
          </div>
