          ...
          <div class="row">
            <!-- <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="row">
                  <div class="col-md-6"> -->
                    <h3 class="ti-star mr-3 mt-3"> List of Student</h3>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th scope="row">{{ $loop->iteration }}</th>
                            ...
                            <td>
                              <a href="{{ url('/siswa/edit/'.$dataSiswa->id) }}" class="btn btn-success ti-pencil-alt mr-2"> Edit</a>   

                              <form action="{{ url('/siswa/delete/'.$dataSiswa->id) }}" method="POST" class="d-inline">
                                @method('delete')
                                @csrf
                              ...
                              <a href="{{ url('/siswa/details/'.$dataSiswa->id) }}" class="btn btn-secondary ti-search mr-2"> Details</a>
                          </td>                          
                        </tr>                       
                        @endforeach   
                      </tbody>                      
                    </table>
                    <a href="{{ url('siswa/create') }}" class="btn btn-info mt-2 ti-plus mr-2"> Add Student</a> 
                    <a href="{{ url('/siswa/print') }}" target="_blank" class="btn btn-warning mt-2 ti-printer mr-2"> Print</a>
                  </div>                
                </div>
              </div>
            </div>
