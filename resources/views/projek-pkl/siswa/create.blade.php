          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">  
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    <h3 class="ti-pencil-alt mr-3 mt-3 ml-3"> Form Add New Student</h3><hr style="width: 150vh;">

                    <form action="{{ url('siswa') }}" method="POST" class="ml-3 mt-3">
                        @csrf
                        <div class="mb-3">
                            <label for="nis" class="form-label">SPN :</label>
                            <input type="text" name="nis" class="form-control" id="nis" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="nama_siswa" class="form-label">Student Name :</label>
                            <input type="text" name="nama" class="form-control" id="nama_siswa" style="width: 120vh;">
                        </div>                        
                        <div class="mb-3">
                            <label for="tempat_lahir" class="form-label">Place of Birth :</label>
                            <input type="text" name="tempat_lahir" class="form-control" id="tempat_lahir" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="tanggal_lahir" class="form-label">Date of Birth :</label>
                            <input type="date" name="tanggal_lahir" class="form-control" id="tanggal_lahir" style="width: 120vh;">
                        </div>
                        <div class="mb-3">                            
                            <label for="disabledSelect" class="form-label">Gender :</label>
                            <select id="disabledSelect" name="jk" class="form-select" style="width: 120vh;">
                        ...
                        <div class="mb-3">                            
                            ...
                            <select id="disabledSelect" name="agama" class="form-select" style="width: 120vh;">
                        ...
                        <div class="mb-3">                            
                            ...
                            <select id="disabledSelect" name="gol_dar" class="form-select" style="width: 120vh;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kelas" class="form-control" id="class" style="width: 120vh;">
                        </div>
                        <div class="mb-3">                            
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="no_telp" class="form-control" id="number_telp" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
