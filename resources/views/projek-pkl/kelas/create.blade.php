              ...
              <div class="card">  
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    ...
                    <form action="{{ url('kelas') }}" method="POST" class="ml-3 mt-3">
                        @csrf                        
                        <div class="mb-3">
                            <label for="kode" class="form-label">Kelas Code :</label>
                            <input type="text" name="kode_kelas" class="form-control" id="kode" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Class :</label>
                            <input type="text" name="nama_kelas" class="form-control" id="nama" style="width: 120vh;">
                        </div>      
                        <div class="mb-3">
                            <label for="wali_kelas" class="form-label">Homeroom Teacher :</label>
                            <input type="text" name="wali_kelas" class="form-control" id="wali_kelas" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="spp" class="form-label">Money Order :</label>
                            <input type="text" name="spp" class="form-control" id="spp" style="width: 120vh;">
                        </div>                 
