          ...
          <div class="row">
            <!-- <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="row">
                  <div class="col-md-6"> -->
                    <a href="/kelas" class="text-dark" style="text-decoration: none;"><h3 class="ti-blackboard mr-3 mt-3"> List of Class</h3></a>
                    ...
                    <table class="table table-hover table-light text-center mt-3">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $dataKelas->spp }}</td>
                          <td>
                          <a href="{{ url('/kelas/edit/'.$dataKelas->id) }}" class="btn btn-success ti-pencil-alt mr-2"> Edit</a>     
                                              
                            <form action="{{ url('/kelas/delete/'.$dataKelas->id) }}" method="POST" class="d-inline">
                              @method('delete')
                              @csrf
                    ...
                    <a href="{{ url('kelas/create') }}" class="btn btn-info mt-2 ti-plus mr-2"> Add Class</a> 
