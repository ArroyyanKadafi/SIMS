          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">  
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    <h3 class="ti-blackboard mr-3 mt-3 ml-3"> Form Add Class</h3><hr style="width: 150vh;">

                    <form action="{{ url('/kelas/update/'.$kelas->id) }}" method="POST" class="ml-3 mt-3">
                        @method('PUT')
                        @csrf                        
                        <div class="mb-3">
                            <label for="kode" class="form-label">Kelas Code :</label>
                            <input type="text" name="kode_kelas" class="form-control" id="kode" style="width: 120vh;" value="{{ $kelas->kode_kelas }}">
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Class :</label>
                            <input type="text" name="nama_kelas" class="form-control" id="nama" style="width: 120vh;" value="{{ $kelas->nama_kelas }}">
                        </div>      
                        <div class="mb-3">
                            <label for="wali_kelas" class="form-label">Homeroom Teacher :</label>
                            <input type="text" name="wali_kelas" class="form-control" id="wali_kelas" style="width: 120vh;" value="{{ $kelas->wali_kelas }}">
                        </div>
                        <div class="mb-3">
                            <label for="spp" class="form-label">Money Order :</label>
                            <input type="text" name="spp" class="form-control" id="spp" style="width: 120vh;" value="{{ $kelas->spp }}">
                        </div>                 
