          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    <!-- <h3 class="ti-home mr-3 mt-3"> List of Department</h3> -->
                    <h3 class="ti-credit-card ml-3 mt-3 mr-2"> Payroll</h3><hr style="width: 150vh;">                       
                    <form action="{{ url('penggajian/update/' .$gaji->id) }}" method="POST" class="ml-3 mt-3">
                    @method('PUT')
                        @csrf
                        <div class="mb-3">
                            <label for="nip" class="form-label">EIN :</label>
                            <input type="text" name="nip" class="form-control" id="nip" style="width: 120vh;" value="{{$gaji->nip}}">
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Teacher Name :</label>
                            <input type="text" name="nama" class="form-control" id="nama" style="width: 120vh;" value="{{$gaji->nama}}">
                        </div>
                        <div class="mb-3">
                            <label for="bulan" class="form-label">Month :</label>
                            <input type="month" name="bulan" class="form-control" id="bulan" style="width: 120vh;" value="{{$gaji->bulan}}">
                        </div>
                        <div class="mb-3">
                            <label for="tanggal" class="form-label">Date :</label>
                            <input type="date" name="tanggal" class="form-control" id="tanggal" style="width: 120vh;" value="{{$gaji->tanggal}}">
                        </div>
                        <div class="mb-3">
                            <label for="penerimaan" class="form-label">Salary Receipts :</label>
                            <input type="text" name="penerimaan" class="form-control" id="penerimaan" style="width: 120vh;" value="{{$gaji->penerimaan}}">
                        </div>                       
                        <div class="mb-3">
                            <label for="potongan" class="form-label">Pay Cut :</label>
                            <input type="text" name="potongan" class="form-control" id="potongan" style="width: 120vh;" value="{{$gaji->potongan}}">
                        </div>
                        <div class="mb-3">
                            <label for="honor_perjam" class="form-label">Honor every hour :</label>
                            <input type="text" name="honor_perjam" class="form-control" id="honor_perjam" style="width: 120vh;" value="{{$gaji->honor_perjam}}">
                        </div>
                        <div class="mb-3">
                            <label for="total_jam" class="form-label">Total hours :</label>
                            <input type="text" name="total_jam" class="form-control" id="total_jam" style="width: 120vh;" value="{{$gaji->total_jam}}">
                        </div>
                        <div class="mb-3">
                            <label for="bayar" class="form-label">Paid :</label>
                            <input type="text" name="bayar" class="form-control" id="bayar" style="width: 120vh;" value="{{$gaji->bayar}}">
                        </div>
