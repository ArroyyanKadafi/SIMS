              ...
              <div class="card">
                <!-- <div class="row"> -->
                  <div class="col-md-6">
                    ...
                    <form action="{{ url('penggajian') }}" method="POST" class="ml-3 mt-3">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" class="form-control" id="nama" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="bulan" class="form-label">Month :</label>
                            <input type="month" name="bulan" class="form-control" id="bulan" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="tanggal" class="form-label">Date :</label>
                            <input type="date" name="tanggal" class="form-control" id="tanggal" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="penerimaan" class="form-label">Salary Receipts :</label>
                            <input type="text" name="penerimaan" class="form-control" id="penerimaan" style="width: 120vh;">
                        </div>                       
                        <div class="mb-3">
                            <label for="potongan" class="form-label">Pay Cut :</label>
                            <input type="text" name="potongan" class="form-control" id="potongan" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="honor_perjam" class="form-label">Honor every hour :</label>
                            <input type="text" name="honor_perjam" class="form-control" id="honor_perjam" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="total_jam" class="form-label">Total hours :</label>
                            <input type="text" name="total_jam" class="form-control" id="total_jam" style="width: 120vh;">
                        </div>
                        <div class="mb-3">
                            <label for="bayar" class="form-label">Paid :</label>
                            <input type="text" name="bayar" class="form-control" id="bayar" style="width: 120vh;">
                        </div>
